# sourced from https://raw.githubusercontent.com/mkleehammer/pyodbc/refs/heads/master/src/pyodbc.pyi
# Licensed under https://github.com/mkleehammer/pyodbc/blob/master/LICENSE.txt
...
class Row:
    ...
    # implemented dunder methods
    def __contains__(self, key, /) -> int: ...  # type: ignore[no-untyped-def]
    def __delattr__(self, name, /) -> None: ...  # type: ignore[no-untyped-def]
    def __delitem__(self, key, /) -> None: ...  # type: ignore[no-untyped-def]
    def __eq__(self, value, /) -> bool: ...  # type: ignore[no-untyped-def]
    def __ge__(self, value, /) -> bool: ...  # type: ignore[no-untyped-def]
    def __getattribute__(self, name, /) -> Any: ...  # type: ignore[no-untyped-def]
    def __getitem__(self, key, /) -> Any: ...  # type: ignore[no-untyped-def]
    def __gt__(self, value, /) -> bool: ...  # type: ignore[no-untyped-def]
    def __iter__(self) -> Iterator[Any]: ...
    def __le__(self, value, /) -> bool: ...  # type: ignore[no-untyped-def]
    def __len__(self, /) -> int: ...
    def __lt__(self, value, /) -> bool: ...  # type: ignore[no-untyped-def]
    def __ne__(self, value, /) -> bool: ...  # type: ignore[no-untyped-def]
